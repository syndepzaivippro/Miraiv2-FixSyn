module.exports.config = {
	...
	hasPermssion: 2,
	credits: "NTKhang",
	description: "Bật tắt chế độ selfListen (acc bot đem chat vẫn chạy lệnh), sau khi sử dụng lệnh này bot sẽ khởi động lại",
...
if(args[0] == "on") {var tf = true, onoff = "bật";}
  ...
  api.sendMessage("Đã "+onoff+" chế độ selfListen ",event.threadID);
