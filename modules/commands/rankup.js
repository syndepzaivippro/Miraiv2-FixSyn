...
module.exports.handleEvent = async function({ api, event, Currencies, Users }) {
	...
	if (level > curLevel && level != 1) {
		...
		var messsage = (typeof thread.customRankup == "undefined") ? msg = "Trình độ cào phím của {name} đã đạt tới cấp độ {level} tương tác để tăng thêm cấp độ nhé <3" : msg = thread.customRankup,
			arrayContent;
